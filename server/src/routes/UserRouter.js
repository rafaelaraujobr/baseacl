...
router.get("/user/:id", AuthMiddleware.Auth, AuthMiddleware.permissionAuth('view-users'), UserController.findById);
router.get("/user/", AuthMiddleware.Auth, AuthMiddleware.permissionAuth('view-users'), UserController.findByEmail);
